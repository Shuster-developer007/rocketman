export const NotFound = () => {
	return (
		...
		>
			...
			<g id='freepik--yarn-ball--inject-1'>
				<ellipse
					cx='306.07'
					cy='410.55'
					rx='30.39'
				...
				/>
				<circle cx='294.77' cy='382.08' r='35.81' style={{ fill: '#fff' }} />
				<g style={{ clipPath: 'url(#freepik--clip-path--inject-1)' }}>
					<path
			...
			<g id='freepik--Text--inject-1'>
				...
				<path
					...
					style={{ fill: '#263238' }}
				/>
				<path d='M107.26,265.18v2.39H106v-2.39Z' style={{ fill: '#263238' }} />
				<path
			...
			<g id='freepik--Character--inject-1'>
				<path
					...
					style={{ fill: '#fff' }}
				/>
				<g style={{ clipPath: 'url(#freepik--clip-path-2--inject-1)' }}>
					<path
				...
				<path
					...
					style={{ fill: '#fff' }}
				/>
				<g style={{ clipPath: 'url(#freepik--clip-path-3--inject-1)' }}>
					<path
				...
				<path
					...
					style={{ fill: '#fff' }}
				/>
				<g style={{ clipPath: 'url(#freepik--clip-path-4--inject-1)' }}>
					<path
				...
				<path
					...
					style={{ fill: '#fff' }}
				/>
				<g style={{ clipPath: 'url(#freepik--clip-path-5--inject-1)' }}>
					<path
				...
				<path
					...
					style={{ fill: '#fff' }}
				/>
				<g style={{ clipPath: 'url(#freepik--clip-path-6--inject-1)' }}>
					<path
